// Legal copy ported verbatim from the retired site's PrivacyPolicy.jsx and
// TermsOfService.jsx. Exactly one transformation was applied to every string:
// "Summit Sites" -> "mossimo". Nothing else was touched — not the wording, not
...
export const TERMS_SECTIONS = [
  ...
  },
  {
    h: 'Governing Law',
    body: [
      'These Terms are governed by the laws of the Province of Quebec, Canada, without regard to its conflict-of-law rules.',
    ],
  },
  {
