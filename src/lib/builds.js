...
const CATALOGUE = [
  ...
  { slug: 'cuts-and-edges',  name: 'Cuts and Edges', category: 'Local trade',  image: '/builds/cutsandedges-hero.jpeg',    blurb: 'Lawn care, presented as editorial rather than trades. Drone footage, a serif masthead, and the services as a numbered list.',
    ...
    year: '2025',
    discipline: 'Design & build',
    challenge: 'Lawn care sites almost all look the same: a template, a stock photo of a mower, a quote form. Looking like every competitor is the fastest way to end up competing on price alone.',
    approach: 'Treat it as an editorial brand instead. Drone footage of the actual work, a serif masthead, a cream palette, and the services as a numbered list rather than a grid of icons. Built bilingual, EN and FR, because Montreal.',
    outcome: 'It reads like a company that takes the work seriously, which is the whole argument for charging more than the person using the template.',
  },
